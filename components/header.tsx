      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="hidden md:block">
            <Button className="relative rounded-full border border-white/30 bg-gradient-to-r from-teal-900/20 to-cyan-200/20 px-5 py-6 font-semibold text-foreground shadow-[0_8px_32px_0_rgba(20,184,166,0.4)] backdrop-blur-lg transition-all duration-300 before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-r before:from-teal-500/0 before:via-white/20 before:to-teal-500/0 before:opacity-0 before:transition-opacity before:duration-500 hover:from-teal-800/50 hover:to-teal-900/50 hover:shadow-[0_8px_32px_0_rgba(13,148,136,0.6)] hover:before:opacity-100">
