...
const REGIONS = [
  { name: "News Scraping", status: "ONLINE", latency: "3.8ms" },
  { name: "Pre-processing", status: "ONLINE", latency: "4.1ms" },
  { name: "Ticker Identification", status: "ONLINE", latency: "4.6ms" },
  { name: "Sentiment Analysis", status: "ONLINE", latency: "4.2ms" },
  { name: "Vectorisation & Embedding", status: "ONLINE", latency: "4.2ms" },
]
